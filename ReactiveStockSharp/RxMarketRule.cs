namespace ReactiveStockSharp
{
    ...
    public static class RxMarketRule
    {
        ...
        public static IObservable<(CandleSeries Series, Candle Candle)> RxWhenCandles(this Connector connector,
            CandleSeries series)
        {
            if (series == null)
        ...
        public static IObservable<Trade> RxWhenNewTrade(this Security security, IConnector connector)
        {
            ...
            {
                var basket = security as BasketSecurity;
                return basket?.Contains(ConfigManager.GetService<ISecurityProvider>(), t.Security) ??
                       t.Security == security;
            });
        }
        ...
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Security> RxWhenBestBidPriceMore(this Security security, IConnector connector,
            Unit price)
        {
            if (security == null)
                throw new ArgumentNullException(nameof(security));
        ...
        /// <param name="price">The level. If the <see cref="Unit.Type"/> type equals to <see cref="UnitTypes.Limit"/>, specified price is set. Otherwise, shift value is specified.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Security> RxWhenBestAskPriceMore(this Security security, IConnector connector,
            Unit price)
        {
            if (security == null)
                throw new ArgumentNullException(nameof(security));
        ...
        /// <param name="price">The level. If the <see cref="Unit.Type"/> type equals to <see cref="UnitTypes.Limit"/>, specified price is set. Otherwise, shift value is specified.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Security> RxWhenBestBidPriceLess(this Security security, IConnector connector,
            Unit price)
        {
            if (security == null)
                throw new ArgumentNullException(nameof(security));
        ...
        /// <param name="price">The level. If the <see cref="Unit.Type"/> type equals to <see cref="UnitTypes.Limit"/>, specified price is set. Otherwise, shift value is specified.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Security> RxWhenBestAskPricLess(this Security security, IConnector connector,
            Unit price)
        {
            if (security == null)
                throw new ArgumentNullException(nameof(security));
        ...
        /// <param name="price">The level. If the <see cref="Unit.Type"/> type equals to <see cref="UnitTypes.Limit"/>, specified price is set. Otherwise, shift value is specified.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Trade> RxWhenLastTradePriceMore(this Security security, IConnector connector,
            Unit price)
        {
            if (security == null)
                throw new ArgumentNullException(nameof(security));
        ...
        /// <param name="price">The level. If the <see cref="Unit.Type"/> type equals to <see cref="UnitTypes.Limit"/>, specified price is set. Otherwise, shift value is specified.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Trade> RxWhenLastTradePriceLess(this Security security, IConnector connector,
            Unit price)
        {
            if (security == null)
                throw new ArgumentNullException(nameof(security));
        ...
        /// <returns>Reactive Extension.</returns>
        public static IObservable<MarketDepth> RxWhenDepthChanged(this MarketDepth marketDepth)
        {
        ...
        /// <returns>Reactive Extension.</returns>
        public static IObservable<MarketDepth> RxWhenSpreadMore(this MarketDepth marketDepth, Unit price)
        {
            if (marketDepth == null)
        ...
        /// <param name="price">The shift value.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<MarketDepth> RxWhenBestBidPriceMore(this MarketDepth marketDepth, Unit price)
        {
            if (marketDepth == null)
                throw new ArgumentNullException(nameof(marketDepth));
            return marketDepth.RxQuotesChanged()
                .Where(_ => marketDepth.BestBid != null && marketDepth.BestBid.Price > price);
        }
        ...
        /// <param name="price">The shift value.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<MarketDepth> RxWhenBestAskPriceMore(this MarketDepth marketDepth, Unit price)
        {
            if (marketDepth == null)
                throw new ArgumentNullException(nameof(marketDepth));
            return marketDepth.RxQuotesChanged()
        ...
        /// <param name="price">The shift value.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<MarketDepth> RxWhenBestBidPriceLess(this MarketDepth marketDepth, Unit price)
        {
            if (marketDepth == null)
                throw new ArgumentNullException(nameof(marketDepth));
            return marketDepth.RxQuotesChanged()
        ...
        /// <param name="price">The level. If the <see cref="Unit.Type"/> type equals to <see cref="UnitTypes.Limit"/>, specified price is set. Otherwise, shift value is specified.</param>
        /// <returns>Reactive Extension.</returns>
        public static IObservable<Candle> RxWhenClosePriceLess(this ICandleManager candleManager, Candle candle,
            Unit price)
        {
            if (candle == null)
        ...
        public static IObservable<Candle> RxWhenFinished(this ICandleManager candleManager, Candle candle)
        {
            if (candle == null)
                throw new ArgumentNullException(nameof(candle));
            return candleManager.RxProcessing()
                .Where(arg => arg.Candle == candle && arg.Candle.State == CandleStates.Finished)
                .Select(arg => arg.Candle);
        }
